...
- Jensen JH, Helpern JA, Ramani A, Lu H, Kaczynski K (2005)

  - Title: Diffusional kurtosis imaging: the quantification of non-Gaussian water diffusion by means of MRI
  - Journal: Magn Reson Med
  - DOI: `https://doi.org/10.1002/mrm.20508`_
  - Derivatives introduced: Diffusion kurtosis (excess kurtosis)
  - Summary: Introduced DKI as an MRI method to quantify departures from Gaussian diffusion due to tissue structure. Reported that excess diffusional kurtosis is significantly higher in white matter than in gray matter, consistent with more restrictive barriers.
  - Google Scholar citations: 3172
  - Citation retrieval date: 11/6/25

- Lu H, Jensen JH, Ramani A, Helpern JA (2006)

  - Title: Three-dimensional characterization of non-Gaussian water diffusion in humans using diffusion kurtosis imaging
  - Journal: NMR Biomed
  - DOI: `https://doi.org/10.1002/nbm.1020`_
  - Derivatives introduced: Diffusion kurtosis tensor
  - Summary: First full derivation of the diffusion kurtosis tensor; defined rotationally invariant metrics (e.g., mean kurtosis) and demonstrated robust kurtosis maps and sensitivity to complex fiber architecture (e.g., multiple fiber orientations within a voxel).
  - Google Scholar citations: 549
  - Citation retrieval date: 11/6/25

- Jensen JH, Helpern JA (2010)

  - Title: MRI quantification of non-Gaussian water diffusion by kurtosis analysis
  - Journal: NMR Biomed
  - DOI: `https://doi.org/10.1002/nbm.1518`_
  - Derivatives introduced: Mean, axial, and radial kurtosis (MK, AK, RK)
  - Summary: Comprehensive theoretical formulation of DKI and the rotational invariants MK, AK, RK. Discussed acquisition needs (≥ 3 b-values, ≥ 15 directions) and highlighted sensitivity of DKI to microstructural heterogeneity and pathology.
  - Google Scholar citations: 584
  - Citation retrieval date: 11/6/25

- Tabesh A, Jensen JH, Ardekani BA, Helpern JA (2011)

  - Title: Estimation of tensors and tensor-derived measures in diffusional kurtosis imaging
  - Journal: Magn Reson Med
  - DOI: `https://doi.org/10.1002/mrm.22655`_
  - Derivatives introduced: Kurtosis fractional anisotropy (KFA)
  - Summary: Presented a constrained DKI fitting method ensuring physically plausible estimates; provided analytical solutions for MK and RK and defined KFA, improving robustness and enabling shorter scans or higher resolution.
  - Google Scholar citations: 382
  - Citation retrieval date: 11/6/25

- Fieremans E, Jensen JH, Helpern JA (2011)

  - Title: White matter characterization with diffusional kurtosis imaging
  - Journal: NeuroImage
  - DOI: `https://doi.org/10.1016/j.neuroimage.2011.06.006`_
  - Derivatives introduced: Axonal water fraction (AWF), tortuosity, intra/extra-axonal diffusivities (via WMTI)
  - Summary: Bridged DKI metrics to biophysical parameters using a two-compartment model, deriving AWF and extra-axonal tortuosity; linked DKI to interpretable microstructural indices.
  - Google Scholar citations: 714
  - Citation retrieval date: 11/6/25

- DKI was first introduced by Jensen et al. (2005) as an extension of DTI to measure **diffusion non-Gaussianity** in tissues (`pubmed.ncbi.nlm.nih.gov <https://pubmed.ncbi.nlm.nih.gov/15906300/#:~:text=A%20magnetic%20resonance%20imaging%20method,metric%20of%20the%20departure%20from>`_). Their seminal work defined **diffusional kurtosis** as a quantitative marker, showing that normal white matter has substantially higher kurtosis than gray matter (`pubmed.ncbi.nlm.nih.gov <https://pubmed.ncbi.nlm.nih.gov/15906300/#:~:text=provides%20an%20estimate%20for%20the,with%20a%20variety%20of%20neuropathologies>`_).
...
- Falangola MF, Jensen JH, Babb JS, Hu C, Castellanos FX, Di Martino A, Ferris SH, Helpern JA (2008)

  - Title: Age-related non-Gaussian diffusion patterns in the prefrontal brain
  - Journal: J Magn Reson Imaging
  - DOI: `https://doi.org/10.1002/jmri.21604`_
  - N: 24; Design: Cross-sectional; Population: Healthy adolescents, adults, elderly (13–85 years)
  - Metrics: MK, MD, FA
  - Key findings: MK showed distinct age-related patterns across adolescence to old age; MD increased and FA decreased in older adults; MK captured microstructural changes in both gray and white matter aligned with development and aging.
  - Google Scholar citations: 302; Citation retrieval date: 11/6/25

- Paydar A, Fieremans E, Nwankwo JI, Lazar M, Sheth HD, Adisetiyo V, Helpern JA, Jensen JH, Milla SS (2014)

  - Title: Diffusional Kurtosis Imaging of the Developing Brain
  - Journal: AJNR Am J Neuroradiol
  - DOI: `https://doi.org/10.3174/ajnr.A3764`_
  - N: 59; Design: Cross-sectional; Population: Healthy infants and young children (birth to 4.6 years)
  - Metrics: FA, MK (± tractography)
  - Key findings: FA and MK increased with age in WM, but MK continued to rise after FA plateaued; MK detected prolonged maturation and revealed GM changes undetectable by FA.
  - Google Scholar citations: 123; Citation retrieval date: 11/6/25

- Coutu JP, Chen JJ, Rosas HD, Salat DH (2014)

  - Title: Non-Gaussian water diffusion in aging white matter
  - Journal: Neurobiol Aging
  - DOI: `https://doi.org/10.1016/j.neurobiolaging.2013.12.001`_
  - N: 111; Design: Cross-sectional; Population: Healthy adults (~33–91 years)
  - Metrics: MK, KFA, DTI metrics
  - Key findings: MK and kurtosis anisotropy declined with age even in mid-adulthood; MK was a more sensitive marker of WM aging than FA/MD, capturing microstructural complexity loss.
  - Google Scholar citations: 109; Citation retrieval date: 11/6/25
