...
# Notes on QSIRecon-specific style:
...
sys.path.insert(0, os.path.abspath("../qsirecon"))
...
version = qsirecon.__version__
# The full version, including alpha/beta/rc tags.
release = qsirecon.__version__
...
# html_title = u'qsirecon vversion'
...
htmlhelp_basename = "qsirecon_doc"
...
latex_documents = [
    (master_doc, "qsirecon.tex", "qsirecon Documentation", author, "manual"),
]
...
man_pages = [(master_doc, "qsirecon", "qsirecon Documentation", [author], 1)]
...
linkcode_resolve = make_linkcode_resolve(
    "qsirecon",
    (
        "https://github.com/pennlinc/qsirecon/blob/"
