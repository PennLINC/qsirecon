...
`github <https://github.com/PennLINC/qsirecon/tree/main/qsirecon/data/pipelines>`_. For extra
...
The Built-In recon workflows can be easily selected by specifying their name (the value in the Name column)
after the ``--recon-spec`` flag (e.g. ``--recon-spec amico_noddi``). Not all workflows are suitable for all
kinds of dMRI data. This table shows which of the
...
Which workflows are appropriate for your data?
==============================================
