...
def copy_reportlets(in_dir, out_dir, participant_label):
    import shutil

    in_path = Path(in_dir)
    out_path = Path(out_dir)

    subject_htmls = (in_path / participant_label).glob("figures/*.html")
    ...
    session_htmls = (in_path / participant_label).glob("ses-*/figures/*.html")
